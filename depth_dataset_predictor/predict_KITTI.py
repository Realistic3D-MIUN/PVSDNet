...
FILE_PATH = "./samples/KITTI/2011_10_03_drive_0047_sync_image_0000000383_image_02.png"
MODEL_LOCATION = "./checkpoint/depth_only_model.pth"
OUTPUT_LOCATION = './output/KITTI/'
...
transform_1 = transforms.Compose([transforms.Resize((352, 1216)), transforms.ToTensor()])
transform_2 = transforms.Compose([transforms.Resize((320, 1104)), transforms.ToTensor()])
transform_3 = transforms.Compose([transforms.Resize((208, 720)), transforms.ToTensor()])
transform_4 = transforms.Compose([transforms.Resize((176, 608)), transforms.ToTensor()])
...
depth_final = (depth_out_1+depth_out_2+depth_out_3+depth_out_4)/4
