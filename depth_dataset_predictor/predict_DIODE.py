...
FILE_PATH = "./samples/DIODE/00022_00195_outdoor_010_030.png"
MODEL_LOCATION = "./checkpoint/depth_only_model.pth"
OUTPUT_LOCATION = './output/DIODE/'
...
transform_1 = transforms.Compose([transforms.Resize((768, 1024)), transforms.ToTensor()])
transform_2 = transforms.Compose([transforms.Resize((720, 960)), transforms.ToTensor()])
transform_3 = transforms.Compose([transforms.Resize((672, 896)), transforms.ToTensor()])
transform_4 = transforms.Compose([transforms.Resize((528, 704)), transforms.ToTensor()])
transform_5 = transforms.Compose([transforms.Resize((480, 640)), transforms.ToTensor()])
transform_6 = transforms.Compose([transforms.Resize((384, 512)), transforms.ToTensor()])
transform_7 = transforms.Compose([transforms.Resize((288, 384)), transforms.ToTensor()])
