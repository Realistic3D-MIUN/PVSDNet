...
FILE_PATH = "./samples/Sintel/frame_0028_temple.png"
MODEL_LOCATION = "./checkpoint/depth_only_model.pth"
OUTPUT_LOCATION = './output/Sintel/'
...
transform_1 = transforms.Compose([transforms.Resize((432, 1024)), transforms.ToTensor()])
transform_2 = transforms.Compose([transforms.Resize((416, 976)), transforms.ToTensor()])
transform_3 = transforms.Compose([transforms.Resize((368, 864)), transforms.ToTensor()])
transform_4 = transforms.Compose([transforms.Resize((320, 752)), transforms.ToTensor()])
transform_5 = transforms.Compose([transforms.Resize((272, 640)), transforms.ToTensor()])
transform_6 = transforms.Compose([transforms.Resize((224, 528)), transforms.ToTensor()])
...
depth_final = (depth_out_1+depth_out_2+depth_out_3+depth_out_4+depth_out_5+depth_out_6)/6
